...
const EnhancedMonthlyPaymentForm = ({
  jobId,
  jobType,
  onClose,
  onSuccess,
  isAccountingMode = false,
}) => {
  // Form state
  ...
  return (
    ...
    >
      ...
      {/* Accounting mode notice */}
      {isAccountingMode && (
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start">
          <InformationCircleIcon className="h-6 w-6 text-blue-500 mr-3 flex-shrink-0 mt-0.5" />
          <div>
            <h4 className="font-medium text-blue-800">
              Accounting Department Instructions
            </h4>
            <p className="mt-1 text-sm text-blue-700">
              This form is for recording monthly payments for completed
              operation jobs. Please ensure:
            </p>
            <ul className="mt-2 text-sm text-blue-700 list-disc pl-5 space-y-1">
              <li>All invoice details are accurate</li>
              <li>Upload proper invoice documents for each payment</li>
              <li>Double-check payment method and amount information</li>
              <li>Mark the appropriate payment status for tracking</li>
            </ul>
          </div>
        </div>
      )}
...
export default EnhancedMonthlyPaymentForm;
